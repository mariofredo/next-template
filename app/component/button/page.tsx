...
export default function ButtonPage() {
  ...
  return (
    <div className="page_ctr">
      ...
      <div className="page_wrapper">
        <Button variant="solid" colorScheme="primary" text="Submit" loading />
        <Button variant="solid" colorScheme="secondary" text="Submit" loading />
        <Button variant="solid" colorScheme="neutral" text="Submit" loading />
        <Button variant="solid" colorScheme="danger" text="Submit" loading />
        <Button variant="solid" colorScheme="warning" text="Submit" loading />
      </div>
      ...
      <div className="page_wrapper">
        <Button variant="outline" colorScheme="primary" text="Submit" loading />
        <Button variant="outline" colorScheme="secondary" text="Submit" loading />
        <Button variant="outline" colorScheme="neutral" text="Submit" loading />
        <Button variant="outline" colorScheme="danger" text="Submit" loading />
        <Button variant="outline" colorScheme="warning" text="Submit" loading />
      </div>
      ...
      <div className="page_wrapper">
        <Button variant="text" colorScheme="primary" text="Submit" loading />
        <Button variant="text" colorScheme="secondary" text="Submit" loading />
        <Button variant="text" colorScheme="neutral" text="Submit" loading />
        <Button variant="text" colorScheme="danger" text="Submit" loading />
        <Button variant="text" colorScheme="warning" text="Submit" loading />
      </div>
    </div>
  );
}
